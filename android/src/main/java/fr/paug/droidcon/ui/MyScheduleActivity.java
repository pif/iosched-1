...
import fr.paug.droidcon.model.ScheduleHelper;
import fr.paug.droidcon.provider.ScheduleContract;
import fr.paug.droidcon.ui.widget.MyScheduleView;
import fr.paug.droidcon.ui.widget.SlidingTabLayout;
import fr.paug.droidcon.util.*;
...
public class MyScheduleActivity extends BaseActivity implements MyScheduleFragment.Listener {
    ...
    private static final String ARG_CONFERENCE_DAY_INDEX
            = "fr.paug.droidcon.ARG_CONFERENCE_DAY_INDEX";
