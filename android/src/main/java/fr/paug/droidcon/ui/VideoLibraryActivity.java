...
import fr.paug.droidcon.ui.widget.DrawShadowFrameLayout;
...
public class VideoLibraryActivity extends BaseActivity implements VideoLibraryFragment.Callbacks {
    ...
    private static final String STATE_KEY_YEAR = "fr.paug.iosched.STATE_KEY_YEAR";
    private static final String STATE_KEY_TOPIC = "fr.paug.iosched.STATE_KEY_TOPIC";
