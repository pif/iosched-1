...
package fr.paug.droidcon.provider;

import fr.paug.droidcon.appwidget.ScheduleWidgetProvider;
import fr.paug.droidcon.provider.ScheduleContract.Announcements;
import fr.paug.droidcon.provider.ScheduleContract.PeopleIveMet;
import fr.paug.droidcon.provider.ScheduleContract.Blocks;
import fr.paug.droidcon.provider.ScheduleContract.Experts;
import fr.paug.droidcon.provider.ScheduleContract.Feedback;
import fr.paug.droidcon.provider.ScheduleContract.MapMarkers;
import fr.paug.droidcon.provider.ScheduleContract.MapTiles;
import fr.paug.droidcon.provider.ScheduleContract.Rooms;
import fr.paug.droidcon.provider.ScheduleContract.SearchSuggest;
import fr.paug.droidcon.provider.ScheduleContract.Sessions;
import fr.paug.droidcon.provider.ScheduleContract.Speakers;
import fr.paug.droidcon.provider.ScheduleContract.Tags;
import fr.paug.droidcon.provider.ScheduleDatabase.SessionsSearchColumns;
import fr.paug.droidcon.provider.ScheduleDatabase.SessionsSpeakers;
import fr.paug.droidcon.provider.ScheduleDatabase.Tables;
import fr.paug.droidcon.util.SelectionBuilder;
...
import fr.paug.droidcon.util.AccountUtils;
...
import static fr.paug.droidcon.util.LogUtils.LOGV;
 ...
 * by {@link fr.paug.droidcon.sync.SyncHelper}, and queried by various
