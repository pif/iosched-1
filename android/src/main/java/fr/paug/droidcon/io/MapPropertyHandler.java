...
import fr.paug.droidcon.io.map.model.MapData;
import fr.paug.droidcon.io.map.model.MapConfig;
import fr.paug.droidcon.io.map.model.Marker;
import fr.paug.droidcon.io.map.model.Tile;
import fr.paug.droidcon.provider.ScheduleContract;
import fr.paug.droidcon.util.MapUtils;
