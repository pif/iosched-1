...
import fr.paug.droidcon.provider.ScheduleContract.SyncColumns;
import fr.paug.droidcon.util.Lists;
import fr.paug.droidcon.util.NetUtils;
...
import static fr.paug.droidcon.util.LogUtils.LOGI;
