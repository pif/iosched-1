...
public class SponsorsActivity extends BaseActivity {
    private static final String TAG = makeLogTag(SponsorsActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null == savedInstanceState) {
            getFragmentManager().beginTransaction()
                    .replace(R.id.container, PartnersFragment.newInstance(false))
                    .commit();
        }
    ...
    protected int getSelfNavDrawerItem() {
        return NAVDRAWER_ITEM_SPONSORS;
    }
